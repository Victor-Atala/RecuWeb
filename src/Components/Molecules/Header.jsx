    ...
    <>
      <nav className="Header">
        ...
        <div className="container-right">
          ...
          <Button size="20" size2="38" borderRadius="3px" color="#FFFFFF" colorText="#000000"><Link to="/Configuracion"><img className='Configuracion' src={Configuracion} alt="Imagen de la tarjeta" /></Link></Button>
        </div>
      </nav>
    </>
  );
