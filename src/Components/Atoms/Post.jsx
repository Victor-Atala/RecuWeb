            ...
            <div className='container-post-info'>
                ...
                <nav className="container-reaction">
                    <div className='interaction'>
                        <img className='img-reaction' src={Like} alt="Me gusta" />
                        <h6><b>{number}</b> <a href='#'>Me gusta</a></h6>
                    </div>
                    <div className='interaction'>
                        <img className='img-reaction' src={Comentario} alt="Comentar" />
                        <h6><b>{number2}</b> <a href='#'>Comentarios</a></h6>
                    </div>
                    <div className='interaction'>
                        <img className='img-reaction' src={Compartir} alt="Compartir" />
                        <h6><b>{number3}</b> <a href='#'>Compartir</a></h6>
                    </div>
                </nav>
            </div>
            <nav className='container-interaction'>
                <div className='interaction-post'>
                    <img className='img-reaction2' src={Like} alt="Me gusta" />
                    <h5>Me gusta</h5>
                </div>
                <div className='container-2-interaction'>
                    <div className='interaction-post2'>
                        <img className='img-reaction2' src={Comentario} alt="Comentar" />
                        <h5>Comentar</h5>
                    </div>
                    <div className='interaction-post2'>
                        <img className='img-reaction2' src={Compartir} alt="Compartir" />
                        <h5>Compartir</h5>
                    </div>
                </div>
            </nav>
